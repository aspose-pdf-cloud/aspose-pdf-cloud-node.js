...
**open** | **boolean** | Gets or sets a flag specifying whether the pop-up annotation should initially be displayed open.<br />*Inherited from [PopupAnnotation](PopupAnnotation.md)* | [optional]
